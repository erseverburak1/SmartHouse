...
public class SummerShiftedGraphics extends ApplicationFrame {
    Operations ops = new Operations();
    FileIO f = new FileIO();
    double[] houseHourlyConsumption;
    Appliance[] appliances;

    public SummerShiftedGraphics(final String title) throws IOException {
        ...
        final XYSeriesCollection data2 = new XYSeriesCollection(series1);
        final JFreeChart chart = ChartFactory.createXYLineChart(
                "Summer Daily Base Loading of the Smart House after the shift-load process",
                "Hours",
                "kw",
                data,

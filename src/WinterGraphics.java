...
public class WinterGraphics extends ApplicationFrame {
    Operations ops = new Operations();
    FileIO f = new FileIO();
    double[] houseHourlyConsumption;
    Appliance[] appliances;

    public WinterGraphics(final String title) throws IOException {
        ...
        final JFreeChart chart = ChartFactory.createXYLineChart(
                "Winter Daily Base Loading of the Smart House",
                "Hours",
                "kw",
                data,
        ...
        chartPanel.setPreferredSize(new java.awt.Dimension(740, 400));
